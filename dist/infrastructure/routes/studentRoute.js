...
const studentController_1 = __importDefault(
  require("../../adaptors/controllers/studentController")
);
const studentUseCase_1 = __importDefault(
  require("../../useCase/studentUseCase")
);
...
const courseController_1 = __importDefault(
  require("../../adaptors/controllers/courseController")
);
...
const chapter_2 = __importDefault(
  require("../../adaptors/controllers/chapter")
);
const multer_1 = __importDefault(require("../middleware/multer"));
const enrolled_1 = __importDefault(require("../repository/enrolled"));
const enrolledCourse_1 = __importDefault(
  require("../../useCase/enrolledCourse")
);
const enrollController_1 = __importDefault(
  require("../../adaptors/controllers/enrollController")
);
...
const reviewController_1 = __importDefault(
  require("../../adaptors/controllers/reviewController")
);
const studentAuth_1 = __importDefault(require("../middleware/studentAuth"));
const category_1 = __importDefault(
  require("../../adaptors/controllers/category")
);
const categoryUseCase_1 = __importDefault(
  require("../../useCase/categoryUseCase")
);
...
const chatController_1 = __importDefault(
  require("../../adaptors/controllers/chatController")
);
const favouriteContoller_1 = __importDefault(
  require("../../adaptors/controllers/favouriteContoller")
);
const favouriteRepo_1 = __importDefault(require("../repository/favouriteRepo"));
const favouriteUseCase_1 = __importDefault(
  require("../../useCase/favouriteUseCase")
);
const question_1 = __importDefault(require("../repository/question"));
const questionUseCase_1 = __importDefault(
  require("../../useCase/questionUseCase")
);
const questionController_1 = __importDefault(
  require("../../adaptors/controllers/questionController")
);
...
const studentUseCase = new studentUseCase_1.default(
  otp,
  repository,
  jwt,
  bcrypt,
...
router
  ...
  .patch(studentAuth_1.default, (req, res) =>
    controller.updateProfile(req, res)
  );
router.patch(
  "/update_image",
  studentAuth_1.default,
  multer_1.default.single("image"),
  (req, res) => controller.updateImage(req, res)
);
router.post("/stripe_payment", studentAuth_1.default, (req, res) =>
  courseController.payment(req, res)
);
router
  .route("/enroll")
  .post(studentAuth_1.default, (req, res) => enrollController.enroll(req, res))
  .get(studentAuth_1.default, (req, res) =>
    enrollController.checkEnroll(req, res)
  );
router.post("/create_chat", studentAuth_1.default, (req, res) =>
...
router.get("/enrolled_course", studentAuth_1.default, (req, res) =>
...
router
  .route("/progress")
  .post(studentAuth_1.default, (req, res) =>
    enrollController.saveProgress(req, res)
  )
  .get(studentAuth_1.default, (req, res) =>
    enrollController.checkProgress(req, res)
  );
router.post("/progress", studentAuth_1.default, (req, res) =>
  enrollController.saveProgress(req, res)
);
router.get("/get_instructor", studentAuth_1.default, (req, res) =>
  courseController.getInstructor(req, res)
);
router.get("/get_chatlist", studentAuth_1.default, (req, res) =>
  chatController.fetchChatList(req, res)
);
router.get("/get_conversations", studentAuth_1.default, (req, res) =>
  chatController.fetchConversation(req, res)
);
router
  .route("/favourite")
  .post(studentAuth_1.default, (req, res) =>
    favouriteController.addToFavourite(req, res)
  )
  .get(studentAuth_1.default, (req, res) =>
    favouriteController.fetchFavourites(req, res)
  );
router.post("/answer", studentAuth_1.default, (req, res) =>
...
router.post("/save_courseprogress", studentAuth_1.default, (req, res) =>
  enrollController.courseProgress(req, res)
);
router.get("/invoice", studentAuth_1.default, (req, res) =>
